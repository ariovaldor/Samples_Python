...
# Eliminar virgulas do texto (,)
texto = speech_text.replace(",","")

# Eliminar pontos (.)
texto1 = texto.replace(".","")

# Eliminar dois pontos(:)
...
arquivo = open('words_freq.txt','w')

arquivo.write("Palavra,Frequência \n")

for key, value in cnt.items():
    key_str = str(key)
    value_str = str(value)
    lin_word_freq = key_str+","+value_str+"\n"
    arquivo.write(lin_word_freq)
    print(key, value)
