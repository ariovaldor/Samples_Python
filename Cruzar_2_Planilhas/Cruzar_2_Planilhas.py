...
df_1 = pd.read_excel("d:/Ari_ESTUDOS/PHYTON/Projetos/Cruzar_2_Planilhas/Datasets/Planilha1.xlsx")
print(df_1)


df_2 = pd.read_excel("d:/Ari_ESTUDOS/PHYTON/Projetos/Cruzar_2_Planilhas/Datasets/Planilha2.xlsx")
print(df_2)
